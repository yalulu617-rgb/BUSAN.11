...
(function() {
  ...
  const maps = {
    ...
    spaland_centum: { name: 'Spa Land Centum City', address: '부산 해운대구 센텀남대로 35', naver: 'https://naver.me/5Q372Aqt', google: googlePlace('Spa Land Centum City', 'ChIJDT_5v8aSaDURXW8rEbumGh8') },
    ...
    gwangalli_beach: { name: 'Gwangalli Beach', address: '부산 수영구 광안해변로 219', naver: 'https://naver.me/GdbmVbn7', google: googlePlace('Gwangalli Beach', 'ChIJxw7HJy_taDUR-xaSTeHwbf8') },
    ...
    busan_station: { name: 'Busan Station', address: '부산 동구 중앙대로 206', naver: 'https://naver.me/5ewqfrxp', google: googlePlace('Busan Station', 'ChIJqxrVY9jraDURTqBi-qe-mAI') },
    ...
    arte_museum_busan: { name: 'ARTE MUSEUM BUSAN', address: '부산 영도구 해양로247번길 29', naver: 'https://naver.me/FIfsvnna', google: googlePlace('ARTE MUSEUM BUSAN', 'ChIJvX_SQwDvaDURS28S4RX5ZVM') },
    gyeongju_museum: { name: 'Gyeongju National Museum', address: '경북 경주시 일정로 186', naver: 'https://naver.me/5qRAK9AB', google: googlePlace('Gyeongju National Museum', 'ChIJRawRj0NOZjURV-Bwn4zSng4') },
    donggungwon: { name: 'Donggungwon', address: '경북 경주시 보문로 74-14', naver: 'https://naver.me/xrxQgB1X', google: googlePlace('Donggungwon', 'ChIJHzgXmHVSZjURIBjSR8nQj3I') },
    nampo_samgyetang: { name: 'Nampo Samgyetang', address: '부산 중구', naver: 'https://naver.me/FqS4z5Rq' },
    gwangalli_bulgogi_busanjip: { name: '광안리 언양불고기 부산집', address: '부산 수영구', naver: 'https://naver.me/FRDW7FyX' },
