...
(function() {
  ...
  "rainPlans": {
    "day2": {
      "trigger": "膠囊列車遇強風大雨停駛 / 廣安無人機取消",
      "proposals": [
        {
          "title": "室內備案 1：BUSAN X the SKY 100樓景觀展望台",
          "desc": "前往海雲台 LCT Landmark Tower 100 樓，全玻璃室內景觀台俯瞰煙雨濛濛的海雲台海岸，並在「全世界最高的星巴克」喝咖啡避雨。"
        },
        {
          "title": "室內備案 2：Spa Land 汗蒸幕延長至 4 小時",
          "desc": "直接將新世界 Spa Land 汗蒸幕時間拉長，享受 18 種不同溫度的三溫暖溫泉池與芬蘭桑拿房，在豪華躺椅區邊喝甜米釀邊放鬆。"
        },
        {
          "title": "室內備案 3：廣安里海景室內景觀餐廳",
          "desc": "若週六無人機秀取消，晚餐改選廣安里沿海高樓室內景觀餐廳，隔著大落地窗邊吃海鮮火鍋邊看廣安大橋雨夜霓虹。"
        }
      ]
    },
    "day3": {
      "trigger": "慶州戶外大陵苑雨勢過大 / 無法戶外散步",
      "proposals": [
        {
          "title": "室內備案 1：皇理團路室內韓屋咖啡廳外拍",
          "desc": "租借高級韓服後改在皇理團路的精緻韓屋咖啡廳室內取景，享受熱柚子茶與庭園雨景。"
        },
        {
          "title": "室內備案 2：國立慶州博物館 (免費室內首選)",
          "desc": "國寶級新羅金冠、精緻金飾腰帶與「聖德大王神鐘」皆在室內展出，館藏極度豐富且全程免淋雨。"
        },
        {
          "title": "室內備案 3：慶州東宮園 (Donggungwon)",
          "desc": "大型室內溫室花園與鳥園，全透明溫室內恆溫舒適，漫步熱帶植物與古羅馬風造景。"
        }
      ]
    },
    "day4": {
      ...
      "proposals": [
        {
          ...
          "desc": "2026 釜山全新頂級室內景點！超大型沉浸式數位光影藝術展，包含巨浪、花海與星空投影。"
        },
        {
          "title": "室內備案 2：Footbath Cafe View 2號店 (照常進行)",
          "desc": "大面落地窗海景精油足湯本身就是絕佳室內享受，雨天泡熱水看海景更顯愜意。"
        },
        {
  ...
  "convenienceCombos": [
    {
      "name": "蟹膏拌飯神仙組合",
      "formula": "GS25 束草紅雪蟹膏 ＋ 微波白飯 ＋ 麻油海苔酥",
      "desc": "熱騰騰白飯拌入整盒蟹膏與海苔碎，濃郁海味入口即化。"
    },
    {
      "name": "經典馬克定食 (Mark Meal)",
      "formula": "辣炒年糕碗 ＋ 三養辣雞麵 ＋ 撕裂起司條 ＋ 微波熱狗",
      "desc": "年糕與辣雞麵微波後鋪上起司與熱狗，牽絲香辣濃郁。"
    },
    {
      "name": "活力元氣早餐",
      "formula": "全州拌飯三角飯糰 ＋ 感洞卵半熟蛋 ＋ 香蕉牛奶",
      "desc": "開啟一天旅程的黃金營養速食組合。"
    },
    {
      "name": "奢華午後輕食",
      "formula": "延世大學生乳包 ＋ 袋裝黑咖啡/冰塊杯",
